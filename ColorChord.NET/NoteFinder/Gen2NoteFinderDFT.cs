...
public sealed class Gen2NoteFinderDFT
{
    ...
    // Reshaping the error to bound it from <=0.5074% to <=0.3817% is possible with:
    // for (byte Entry = 0; Entry < 16; Entry++) { Values[Entry] = (short)Math.Round(AMPLITUDE * Math.Sin(Entry * Math.Tau / 32) * (Entry == 8 ? 1.0F : 1.002537F)); }
...
#pragma warning restore CS0162 // Unreachable code detected
    ...
    public static Vector256<short> GetSine256(Vector256<ushort> positions) // input treated as sign.4.11 fixed-point number for table index
    {
        ...
        // With error reshaping:
        Vector256<byte> SinWaveVecUpperB = Vector256.Create((byte)0x00, 0x03, 0x06, 0x08, 0x0B, 0x0D, 0x0E, 0x0F, 0x0F, 0x0F, 0x0E, 0x0D, 0x0B, 0x08, 0x06, 0x03, 0x00, 0x03, 0x06, 0x08, 0x0B, 0x0D, 0x0E, 0x0F, 0x0F, 0x0F, 0x0E, 0x0D, 0x0B, 0x08, 0x06, 0x03);
        Vector256<byte> SinWaveVecLowerB = Vector256.Create((byte)0x00, 0x21, 0x23, 0xE9, 0x57, 0x56, 0xD1, 0xBB, 0xFF, 0xBB, 0xD1, 0x56, 0x57, 0xE9, 0x23, 0x21, 0x00, 0x21, 0x23, 0xE9, 0x57, 0x56, 0xD1, 0xBB, 0xFF, 0xBB, 0xD1, 0x56, 0x57, 0xE9, 0x23, 0x21);
